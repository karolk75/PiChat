...
import asyncio
from .schemas.chat import WebSocketCommand
...
class ConnectionManager:
    ...
    async def handle_message(self, message: WebSocketCommand, websocket: WebSocket) -> Optional[Dict[str, Any]]:
        ...
        if action in self.message_handlers:
            ...
            return {"type": "error", "payload": {"message": f"Unknown action: {action}"}} 