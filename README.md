...
1. **Voice Interface**: Voice activation using the phrase "Hey GPT" (configurable) on Raspberry Pi, enabling natural conversation with the AI assistant.
...
- Voice activation through the phrase "Hey GPT" (configurable)
